...
{
    Book *bookOne = new Book(prodName_, price_, qty_, isbn_, author_); 
    return bookOne; 
}
...
{
    Clothing *clothingOne = new Clothing(prodName_, price_, qty_, size_, brand_); 
    return clothingOne; 
}
...
{
    Movie *movieOne = new Movie(prodName_, price_, qty_, genre_, rating_); 
    return movieOne; 
}
